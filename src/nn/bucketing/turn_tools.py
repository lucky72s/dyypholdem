...
def _suitcat_turn(s1, s2, s3, s4, s5, s6):
...
def turn_id(hand: List):
    ...
    cat = _suitcat_turn(s[0], s[1], s[2], s[3], s[4], s[5])
    assert cat != -1, "wrong turn cat"
...
def base(hand):
    v1 = base_values_pow6[hand[0]]
    v2 = base_values_pow5[hand[1]]
    v3 = base_values_pow4[hand[2]]
    v4 = base_values_pow3[hand[3]]
    v5 = base_values_pow2[hand[4]]
    v6 = base_values_pow1[hand[5]]
